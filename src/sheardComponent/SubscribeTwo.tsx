...
const SubscribeTwo = () => {
  return (
    <>
      <div className="subscribe-area hm2">
          ...
          <div className="border-t-gray1 border-b-gray1">
            <div className="row align-items-center">
              <div className="col-xxl-6 col-xl-6  col-lg-6  col-md-10  col-sm-12 col-12 offset-lg-0">
                <div className="subscribe-wrapper border-r-gray1 pt-60 pb-60">
                    ...
                    <form action="#">
                      <div className="d-sm-flex align-items-center">
                        <div className="subscribe-info position-relative mr-6 mb-15">
                          <input
                            className="sub-name form-control border-0 pl-35 h2-theme-color h2-light-black-bg3 rounded-0"
                            type="email"
                            name="name"
                            id="n-sub-name"
                        ...
                        <div className="subscribe-btn mb-15">
                          <div className="d-inline-block">
                            <Link
                              href="#"
                              className="web-btn h2-theme-border1 d-inline-block rounded-0 text-capitalize white h2-theme-bg position-relative over-hidden pl-35 pr-35 ptb-12"
                            >
                              Subscribe
                            </Link>
                          </div>
              ...
              <div className="col-xxl-6 col-xl-6  col-lg-6  col-md-12  col-sm-12 col-12">
                <div className="testimonial-area testimonial-active pb-50 pb-lg-0">
                  <div className="row d-flex align-items-center">
                    <div className="col-xl-4 col-lg-4  col-md-2  col-sm-3 col-12 pr-0 pr-0 pt-6 d-flex justify-sm-content-end justify-content-center">
                      <div className="testimonial-avater position-relative">
                        ...
                        <div className="quote position-absolute">
                          <span className="h2-theme-bg white d-block text-center">
                    ...
                    <div className="col-xl-8  col-lg-8  col-md-7  col-sm-9 col-12  pt-6">
                      <div className="testimonial-comment pl-0 pt-20">
                        ...
                        <div className="testimonial-info d-sm-flex align-items-center pt-20">
                          ...
                          <span className="h2-theme-color">Sr. Authopedic</span>
                        </div>
                      </div>
                    </div>
                  </div>
