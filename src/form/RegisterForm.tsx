      ...
      <form onSubmit={handleSubmit}>
        <div className="position-relative">
          ...
          <input
            ...
            required
          />
          {touched.email && <ErrorMsg errors={errors.name} />}
        </div>
        <div className="position-relative">
          <label htmlFor="email">
        ...
        <div className="position-relative">
          ...
          <input
            ...
            required
          />
          {touched.passwordConfirmation && <ErrorMsg errors={errors.passwordConfirmation} />}
        </div>
        ...
        <button disabled={!isBtnDisable} className={isBtnDisable === false ? "bt-btn bt-btn-black w-100" : "bt-btn theme-btn-2 w-100"} >Register Now</button>
